...
# Installation
for building project we most important need to install python libraries and python packages so needed install commands for windows,linux and mac are given below:
